...
Программа рассчитывает состояние модели согласно начальным данным, а также сохраняет промежуточные состояния с заданной частотой в виде картинки в формате **bmp**.
...
4. Кодирование 1 пикселя должно занимает 4 бит.
...
1. Самостоятельно реализованы функции для работы с картинками в формате bmp.

2. Работа выполнена без использования стандартных контейнеров, с использованием *сырых* указателей.
